    ...
    <div className="min-h-screen bg-white font-serif">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-pink-900 mb-4">All Categories</h1>
        ...
        {categories.length === 0 ? (
          <div className="text-center py-16 bg-pink-50 rounded-xl border border-pink-100 max-w-2xl mx-auto">
            ...
            <h3 className="text-xl font-medium text-pink-900 mb-3">No categories found</h3>
            <p className="text-pink-600 max-w-md mx-auto">No categories have been created yet</p>
          </div>
        ) : (
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {categories.map((category) => (
              ...
              >
                <h3 className="text-xl font-semibold text-pink-800 mb-3">{category.name}</h3>
