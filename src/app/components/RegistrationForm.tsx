      ...
      <div className="w-1/2 bg-white flex justify-center items-center">
        <div className="w-full max-w-md p-8 border border-pink-100 rounded-xl shadow-xl">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-serif text-pink-900 mb-2">Create Your Account</h2>
            <p className="text-pink-600">Start your personal diary journey</p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="ml-2 block text-sm text-pink-700">
                I agree to the <a href="#" className="font-medium text-pink-600 hover:text-pink-500">Terms and Conditions</a>
              </label>
            </div>
